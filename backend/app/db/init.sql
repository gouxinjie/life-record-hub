...
(1, '宫保鸡丁', '荤菜系列', '鸡胸肉 250g, 花生米 50g, 黄瓜 半根, 干辣椒 5个, 豆瓣酱 1勺, 糖 1勺', '1. 鸡肉切丁，用料酒、胡椒粉腌制。\n2. 调酱汁：生抽、陈醋、糖、淀粉和水。\n3. 油炸花生米备用。锅留底油爆香干辣椒和花椒。\n4. 下鸡丁滑散，加豆瓣酱炒出红油。\n5. 下黄瓜丁和花生米，倒入酱汁快速翻炒即可。', 'https://images.unsplash.com/photo-1525755662778-989d0524087e?q=80&w=500', 20, '中等', '麻辣鲜香', 1),
(1, '地三鲜', '素菜系列', '土豆 1个, 茄子 1个, 青椒 1个, 蒜末 适量, 生抽 2勺, 糖 1勺', '1. 土豆、茄子切块，青椒切片。\n2. 锅中热油，分别将土豆块和茄子块炸至金黄捞出。\n3. 锅留底油，爆香蒜末，下青椒翻炒。\n4. 倒入土豆和茄子，加生抽、盐、糖和少许水淀粉勾芡。\n5. 翻炒均匀出锅。', 'https://images.unsplash.com/photo-1623591039704-f5a9f7ff5374?q=80&w=500', 25, '中等', '经典的北方味道', 0),
(1, '皮蛋瘦肉粥', '早餐系列', '大米 100g, 皮蛋 1个, 猪瘦肉 50g, 姜丝 少许, 葱花 适量', '1. 大米淘洗干净，加水大火烧开转小火熬煮。\n2. 瘦肉切丝，用盐和油腌制。\n3. 皮蛋切小块。当粥煮至粘稠时放入皮蛋和瘦肉。\n4. 继续煮5-10分钟，撒上姜丝、葱花和少许盐即可。', 'https://images.unsplash.com/photo-1625220194771-7ebdea0b70b9?q=80&w=500', 40, '简单', '营养早餐，温暖脾胃', 1),
(1, '阳春面', '面食系列', '细面条 150g, 猪油 1勺, 生抽 1勺, 葱花 少许, 盐 适量', '1. 碗中放入猪油、生抽、盐和葱花，冲入半碗开水调成汤底。\n2. 锅中烧水，水开后放入面条煮熟。\n3. 将面条捞入调好汤底的碗中，撒上葱花即可。', 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?q=80&w=500', 10, '简单', '简单而不简约', 0),
(1, '麻婆豆腐', '素菜系列', '嫩豆腐 1块, 肉末 50g, 郫县豆瓣酱 1勺, 花椒粉 适量, 蒜末 适量', '1. 豆腐切方块，用盐水浸泡10分钟。\n2. 锅中热油，下肉末炒散炒香。\n3. 加豆瓣酱、蒜末炒出红油，加水煮开。\n4. 放入豆腐块，小火焖煮3分钟。\n5. 勾薄芡，出锅前撒上厚厚一层花椒粉。', 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?q=80&w=500', 15, '中等', '麻辣烫鲜香嫩', 1),
(1, '冬瓜排骨汤', '汤羹系列', '排骨 300g, 冬瓜 200g, 生姜 3片, 料酒 1勺, 盐 适量', '1. 排骨冷水下锅，加料酒焯水捞出。\n2. 冬瓜去皮切大块。\n3. 砂锅加水，放入排骨和姜片，大火烧开转小火炖40分钟。\n4. 加入冬瓜块继续炖20分钟。\n5. 最后加盐调味即可。', 'https://images.unsplash.com/photo-1547592166-23ac45744acd?q=80&w=500', 60, '简单', '清淡解腻', 0),
(1, '虾仁蒸蛋', '早餐系列', '鸡蛋 2个, 虾仁 6个, 温水 200ml, 生抽 1勺, 香油 少许', '1. 鸡蛋打散，加入温水和少许盐搅拌均匀，过滤掉气泡。\n2. 盖上保鲜膜，水开后上锅中火蒸8分钟。\n3. 放入洗净的虾仁，继续蒸2分钟。\n4. 淋上生抽和香油即可。', 'https://images.unsplash.com/photo-1582890523163-52852d3223f7?q=80&w=500', 15, '简单', '口感细腻如布丁', 1);

-- 5. 笔记的模拟数据
INSERT INTO `note` (`user_id`, `category_path`, `title`, `content`, `content_type`, `is_delete`, `create_time`, `update_time`) VALUES
(1, '/note/daily', '每日随笔', '今天天气真好，适合出去走走。', 0, 0, NOW(), NOW()),
(1, '/note/work', '工作总结', '完成了本周的任务，下周计划开始新项目。', 0, 0, NOW(), NOW()),
(1, '/note/study', '学习笔记 - Python', 'Python 基础语法复习，重点是列表和字典的操作。', 0, 0, NOW(), NOW()),
(1, '/note/life', '生活感悟', '保持积极乐观的心态，面对生活中的挑战。', 0, 0, NOW(), NOW()),
(1, '/note/daily', '读书心得', '《人类简史》读后感：历史的进程总是出人意料。', 0, 0, NOW(), NOW());

-- 6. 待办的模拟数据
INSERT INTO `todo` (`user_id`, `category_path`, `title`, `remark`, `deadline`, `priority`, `status`, `is_starred`, `create_time`, `update_time`) VALUES
(1, '/todos/work', '完成项目报告', '确保所有数据准确无误，并附上图表。', '2026-02-05 17:00:00', 1, 0, 1, NOW(), NOW()),
(1, '/todos/life', '购买生日礼物', '给妈妈买一份特别的生日礼物。', '2026-02-10 00:00:00', 2, 0, 0, NOW(), NOW()),
(1, '/todos/study', '学习新技能', '每天学习一小时 Python 编程。', NULL, 3, 0, 0, NOW(), NOW()),
(1, '/todos/work', '安排团队会议', '讨论下季度工作计划。', '2026-02-03 10:00:00', 1, 0, 1, NOW(), NOW()),
(1, '/todos/life', '健身房锻炼', '每周三次，保持健康。', NULL, 2, 1, 0, NOW(), NOW());